...
<body>
  <nav class="navbar py-4 navbar-light bg-light sticky-top">
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <p class="text-center">
                   <i>Having trouble with WEB DEVLOPMENT, DATA STRUCTURES, FOUNDUATION OF COMPUTER SCIENCE, COMPUTER ORGANIZATONS:</i>
                   <br>
        ...
        <div class="container reveal">
          ...
          <div class="text-container">        
                    <p class="intro bg-light">
                        Our team plans to develop a blogging platform for CS and ITWS students at RPI. Our website aims to provide users with a resource-rich community hub. Any coding question is acceptable; it is not just limited to assignments for the lecture, labs, and exams. Users will be able to connect with people who have similar interests to them on this platform and make new acquaintances they might not have otherwise made in their lectures or lab. We want to create connections between all of our users so they can develop an interest in learning.<br>
                    </p>
              </div>
      ...
      <section>
        <div class="container reveal">
          ...
          <div class="text-container">
            Studies have shown that more people are willing to help people in discord other than submitty form. After interviewing them they have said that they would love to help others and meet new friends but submitty fourms seems to be too formal and sometime may let others feel stupid and wont to able to fully express themselves. 
          </div>
        </div>
      </section>
